...
def detail_url(recipe_id):
    """Create and return a recipe detail id."""
...
class PrivateRecipeApuTests(TestCase):
    ...
    def test_create_user_recipe_with_new_tags(self):
        """Test creating a recipe with new tags."""
        payload = {
            'title': 'Test recipe',
            'time_minutes': 39,
            'price': Decimal('2.56'),
            'tags': [{'name': 'Dessert'}, {'name': 'After lunch'}]
        }
    ...
    def test_create_tag_on_update(self):
        """Test creating a teg when updating a recipe."""
        recipe = create_recipe(user=self.user)
    ...
    def test_create_recipe_with_new_ingredients(self):
        """Test creating arecipe with new ingredients."""
        payload = {
            'title': 'Cauliflower Tacos',
            'time_minutes': 60,
            'price': Decimal('5.50'),
            'ingredients': [{'name': 'Salt'}, {'name': 'Cualiflower'}]
        }
        res = self.client.post(RECIPES_URL, payload, format='json')
    ...
    def test_filter_by_tags(self):
        ...
        r1 = create_recipe(user=self.user, title='Pancack')
    ...
    def test_filter_ingredients(self):
        ...
        r1 = create_recipe(user=self.user, title='Fries')
        r2 = create_recipe(user=self.user, title='Maffins')
        in1 = Ingredient.objects.create(user=self.user, name='Potato')
        in2 = Ingredient.objects.create(user=self.user, name='Flour')
        r1.ingredients.add(in1)
        r2.ingredients.add(in2)
        r3 = create_recipe(user=self.user, title='Cacke')
